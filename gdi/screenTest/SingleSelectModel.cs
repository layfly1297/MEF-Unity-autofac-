...
{
    //下拉单选
    public sealed partial class SingleSelectModel : UserControl
    {
        ...
        private void checkedListBox1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            ControlPaint.DrawBorder(graphics, rec, Color.Blue, ButtonBorderStyle.Solid);
            graphics.Dispose();
    ...
    #region 枚举 和类
    /// <summary>
    /// Items ListSource 数据项模式1 
    /// </summary>
    public class SingelSelectDataModleItems
    {
        //显示文本
    ...
    /// 动态数据集合 SourceName
    /// </summary>
    public class SingelSelectDataModleDataSource
    {

        public SingelSelectDataModleDataSource(string valueMember, string displayMember, object dataSource)
        {
        ...
        //  dataSource.GetType()   object obj = Activator.CreateInstance(type);
    ...
    /// 参数
    /// </summary>
    public class EventArgsListSourceType : EventArgs
    {
        public ListSourceType CurrentType { get; set; }
