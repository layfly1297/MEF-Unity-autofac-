...
/// 文件名称    ：SafeNativeMethods.cs
/// =================================
/// 创 建 者    ：lican
/// 创建日期    ：2018/11/12 18:03:10 
...
namespace TextBoxImitation
{
    ...
    public static class SafeNativeMethods
    {
        ...
        #region extend 调用默认IME 发送显示定位 
         
        [DllImport("imm32.dll")]
        internal static extern IntPtr ImmGetDefaultIMEWnd(IntPtr hWnd);

        [DllImport("user32.dll")]
        internal static extern IntPtr SendMessage(IntPtr hWnd, int msg, IntPtr wParam, COMPOSITIONFORM lParam);
        [DllImport("user32.dll")]
        internal static extern IntPtr SendMessage(IntPtr hWnd, int msg, IntPtr wParam, [In, MarshalAs(UnmanagedType.LPStruct)] LOGFONT lParam);

        [StructLayout(LayoutKind.Sequential)]
        internal class COMPOSITIONFORM
        {
